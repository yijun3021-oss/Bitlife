...
Inside `ageUp`, type the yearly object as the union so v2 crime, prison, achievement, and stats containers survive the age-up spread:
...
- [ ] **Step 5: Wire yearly settlement and unlocks**
